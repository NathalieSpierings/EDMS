...
using Promeetec.EDMS.Domain.Domain.Document.DownloadActivity;
using Promeetec.EDMS.Queries;
using Promeetec.EDMS.Reporting.Document.DownloadActivity.Models;
using Promeetec.EDMS.Reporting.Document.DownloadActivity.Queries;

namespace Promeetec.EDMS.Reporting.Private.Document.DownloadActivity.QueryHandlers
{
