...
public class VerzekeraarsViewModel : ModelBase
{
    public IEnumerable<VerzekeraarViewModel> Verzekeraars { get; set; }
    ...
    protected override void CreateGridContextMenuItems(GridContextMenuViewModel gridContextMenu)
    {
        gridContextMenu.Add(new GridContextMenu
        {
            ...
            Url = UrlAction("Details", "Verzekeraar", new { Area = "Admin" }),
            Roles = new[] { RoleNames.Administrator, RoleNames.RaadplegenVerzekeraars }
        });
    ...
    protected override void CreateSlidepanelTabs(SlidepanelTabsViewModel slidepanel)
    {
        slidepanel.Add(new SlidepanelTab
        {
            ...
            Active = true,
            LoadUrl = UrlAction("Details", "Verzekeraar", new { Area = "Admin" })
        });
