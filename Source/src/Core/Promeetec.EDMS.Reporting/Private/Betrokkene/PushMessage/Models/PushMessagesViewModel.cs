...
public class PushMessagesViewModel : ModelBase
{
    public IList<PushMessageListItemViewModel> Messages { get; set; }
    ...
    protected override void CreateGridContextMenuItems(GridContextMenuViewModel gridContextMenu)
    {
        gridContextMenu.Add(new GridContextMenu
        {
            ...
            Url = UrlAction("Details", "PushMessage", new { Area = "Admin" }),
            Roles = new[] { RoleNames.Administrator, RoleNames.RaadplegenPushMessages }
        });
    ...
    protected override void CreateSlidepanelTabs(SlidepanelTabsViewModel slidepanel)
    {
        slidepanel.Add(new SlidepanelTab
        {
            ...
            Active = true,
            LoadUrl = UrlAction("Details", "PushMessage", new { Area = "Admin" })
        });
