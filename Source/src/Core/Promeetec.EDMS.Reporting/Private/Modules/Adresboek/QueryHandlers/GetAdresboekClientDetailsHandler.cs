...
public class GetAdresboekClientDetailsHandler : IQueryHandlerAsync<GetAdresboekClientDetails, AdresboekClientDetailsViewModel>
{
    private readonly IVerzekerdeRepository _repository;

    public GetAdresboekClientDetailsHandler(IVerzekerdeRepository repository)
    {
        _repository = repository;
    }

    public async Task<AdresboekClientDetailsViewModel> HandleAsync(GetAdresboekClientDetails query)
    {
        ...
        var model = new AdresboekClientDetailsViewModel
        {
            Id = dbQuery.Id,
