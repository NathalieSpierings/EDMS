...
public sealed class IsKetenzorgBehandeldatumAfterToday : ValidationAttribute, IClientValidatable
{
    private readonly string testedPropertyName;
    private readonly bool allowEqualDates;

    public IsKetenzorgBehandeldatumAfterToday(string testedPropertyName, bool allowEqualDates = false)
    {
    ...
    public IEnumerable<ModelClientValidationRule> GetClientValidationRules(ModelMetadata metadata, ControllerContext context)
    {
        var rule = new ModelClientValidationRule
        {
            ...
            ValidationType = "isketenzorgbehandeldatumaftertoday",
