...
public sealed class IsKetenzorgBehandeldatumBeforeDays : ValidationAttribute, IClientValidatable
{
    private readonly string testedPropertyName;
    private readonly bool allowEqualDates;

    public IsKetenzorgBehandeldatumBeforeDays(string testedPropertyName, bool allowEqualDates = false)
    {
    ...
    public IEnumerable<ModelClientValidationRule> GetClientValidationRules(ModelMetadata metadata, ControllerContext context)
    {
        var rule = new ModelClientValidationRule
        {
            ...
            ValidationType = "isketenzorgbehandeldatumbeforedays",
