namespace Promeetec.EDMS.Domain.Modules.Declaratie.Aanlevering
{
    public interface IAanleveringRepository : IRepository<Aanlevering>
    {
        ...
        /// <summary>
        /// Verwijder de events van de gegeven aanlevering.
        /// </summary>
        /// <param name="aanleveringId">The aanlevering identifier.</param>
        Task<int> VerwijderAanleveringEventLog(Guid aanleveringId);
    }
}