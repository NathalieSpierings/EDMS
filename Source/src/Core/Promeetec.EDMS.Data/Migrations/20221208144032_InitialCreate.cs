        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Haarwerk_BedragBasisVerzekeringHaarwerk = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarbonCopyAdressen = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Persoon_Tussenvoegsel = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    ...
                    Persoon_Doorkiesnummer = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Verzekeringsnummer = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Machtigingsnummer = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AgbCodeZorgverlener = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
