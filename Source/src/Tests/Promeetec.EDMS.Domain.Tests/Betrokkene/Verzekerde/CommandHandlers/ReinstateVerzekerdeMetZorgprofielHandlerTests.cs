...
[TestFixture]
public class ReinstateVerzekerdeMetZorgprofielHandlerTests : TestFixtureBase
{
    ...
    [Test]
    public async Task Should_reinstate_verzekerde_with_zorgprofiel_and_add_event()
    {
        ...
        var command = Fixture.Build<ReinstateVerzekerdeMetZorgprofiel>()
        ...
        var sut = new ReinstateVerzekerdeMetZorgprofielHandler(_repository, _eventRepository);
