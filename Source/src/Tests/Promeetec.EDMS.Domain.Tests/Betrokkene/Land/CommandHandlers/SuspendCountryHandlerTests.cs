...
[TestFixture]
public class SuspendCountryHandlerTests : TestFixtureBase
{
    ...
    public async Task Should_suspend_country_and_add_event()
    {
        ...
        var command = Fixture.Build<SuspendCountry>()
        ...
        var sut = new SuspendCountryHandler(_repository, _eventRepository);
