...
[TestFixture]
public class ReinstateCountryHandlerTests : TestFixtureBase
{
    ...
    public async Task Should_reinstate_country_and_add_event()
    {
        ...
        var command = Fixture.Build<ReinstateCountry>()
        ...
        var sut = new ReinstateCountryHandler(_repository, _eventRepository);
