...
[TestFixture]
public class UpdateCountryHandlerTests : TestFixtureBase
{
    ...
    public async Task Should_update_country_and_add_event()
    {
        ...
        var command = Fixture.Build<UpdateCountry>()
        ...
        var validator = new Mock<IValidator<UpdateCountry>>();
        validator.Setup(x => x.ValidateAsync(command, new CancellationToken())).ReturnsAsync(new ValidationResult());

        var sut = new UpdateCountryHandler(_repository, _eventRepository, validator.Object);
