...
[TestFixture]
public class SuspendMedewerkerHandlerTests : TestFixtureBase
{
    ...
    [Test]
    public async Task Should_suspend_medewerker_and_add_event()
    {
        ...
        var command = Fixture.Build<SuspendMedewerker>()
        ...
        var sut = new SuspendMedewerkerHandler(_repository, _eventRepository);
