...
[TestFixture]
public class ConfirmEmailHandlerTests : TestFixtureBase
{
    ...
    [Test]
    public async Task Should_confirm_email_of_medewerker_and_add_event()
    {
        ...
        var command = Fixture.Build<ConfirmEmail>()
        ...
        var sut = new ConfirmEmailHandler(_repository, _eventRepository);
