...
[TestFixture]
public class UpdateHaarwerkValidatorTests : TestFixtureBase
{
    private UpdateHaarwerkValidator _validator;

    [SetUp]
    public void Setup()
    {
        _validator = new UpdateHaarwerkValidator();
    }
    ...
    [Test]
    public void Shoulod_match_regex()
    {
    ...
    {
        var command = Fixture.Build<UpdateHaarwerk>().With(x => x.Naam, string.Empty).Create();
    ...
    {
        var command = Fixture.Build<UpdateHaarwerk>().With(x => x.Naam, "@#909naa").Create();
        var result = _validator.TestValidate(command);
        result.ShouldHaveValidationErrorFor(x => x.Naam);
    }
    ...
    {
        var command = Fixture.Build<UpdateHaarwerk>().With(x => x.Naam, new string('*', 210)).Create();
        var result = _validator.TestValidate(command);
        result.ShouldHaveValidationErrorFor(x => x.Naam);
    }
    ...
    {
        var command = Fixture.Build<UpdateHaarwerk>().With(x => x.Geboortedatum, DateTime.MinValue).Create();
        var result = _validator.TestValidate(command);
    ...
    {
        var command = Fixture.Build<UpdateHaarwerk>().With(x => x.Geboortedatum, DateTime.Now.AddDays(2)).Create();
        var result = _validator.TestValidate(command);
        result.ShouldHaveValidationErrorFor(x => x.Geboortedatum);
    }
    ...
    {
        var command = Fixture.Build<UpdateHaarwerk>().With(x => x.Geboortedatum, new DateTime(75, 7, 22)).Create();
        var result = _validator.TestValidate(command);
        result.ShouldHaveValidationErrorFor(x => x.Geboortedatum);
    }
    ...
    {
        var command = Fixture.Build<UpdateHaarwerk>().With(x => x.Bsn, string.Empty).Create();
        var result = _validator.TestValidate(command);
    ...
    {
        var command = Fixture.Build<UpdateHaarwerk>().With(x => x.Bsn, "0354205023").Create();
        var result = _validator.TestValidate(command);
        result.ShouldHaveValidationErrorFor(x => x.Bsn);
    }
    ...
    {
        var command = Fixture.Build<UpdateHaarwerk>().With(x => x.Afleverdatum, DateTime.MinValue).Create();
        var result = _validator.TestValidate(command);
    ...
    {
        var command = Fixture.Build<UpdateHaarwerk>().With(x => x.Afleverdatum, DateTime.Now.AddDays(2)).Create();
        var result = _validator.TestValidate(command);
        result.ShouldHaveValidationErrorFor(x => x.Afleverdatum);
    }
    ...
    {
        var command = Fixture.Build<UpdateHaarwerk>().With(x => x.Afleverdatum, new DateTime(75, 7, 22)).Create();
        var result = _validator.TestValidate(command);
        result.ShouldHaveValidationErrorFor(x => x.Afleverdatum);
    }
    ...
    {
        var command = Fixture.Build<UpdateHaarwerk>().With(x => x.PrijsHaarwerk, new decimal(0.00)).Create();
        var result = _validator.TestValidate(command);
    ...
    {
        var command = Fixture.Build<UpdateHaarwerk>().With(x => x.PrijsHaarwerk, new decimal(-25.50)).Create();
        var result = _validator.TestValidate(command);
        result.ShouldHaveValidationErrorFor(x => x.PrijsHaarwerk);
    }
    ...
    {
        var command = Fixture.Build<UpdateHaarwerk>().With(x => x.BedragAanvullendeVerzekering, new decimal(0.00)).Create();
        var result = _validator.TestValidate(command);
    ...
    {
        var command = Fixture.Build<UpdateHaarwerk>().With(x => x.BedragAanvullendeVerzekering, new decimal(-25.50)).Create();
        var result = _validator.TestValidate(command);
        result.ShouldHaveValidationErrorFor(x => x.BedragAanvullendeVerzekering);
    }
}