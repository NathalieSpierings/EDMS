...
[TestFixture]
public class VerwerkBehandelplanHandlerTests : TestFixtureBase
{
    ...
    [Test]
    public async Task Should_process_behandelplan_and_add_event()
    {
        ...
        var command = Fixture.Build<ProcessBehandelplan>()
        ...
        var sut = new VerwerkGliRegistratieHandler(_repository, _eventRepository);
