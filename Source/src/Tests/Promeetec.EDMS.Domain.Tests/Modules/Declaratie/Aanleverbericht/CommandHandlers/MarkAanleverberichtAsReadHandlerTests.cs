...
using Promeetec.EDMS.Portaal.Domain.Models.Modules.Declaratie.Aanleverbericht.Handlers;
using Promeetec.EDMS.Portaal.Tests.Helpers;
using Promeetec.EDMS.Tests.Helpers;

namespace Promeetec.EDMS.Portaal.Domain.Tests.Modules.Declaratie.Aanleverbericht.CommandHandlers;


[TestFixture]
public class MarkAanleverberichtAsReadHandlerTests : TestFixtureBase
{
    ...
    {
        var sut = new MarkAanleverberichtAsReadHandler(_repository);
        Assert.ThrowsAsync<DataException>(async () => await sut.Handle(Fixture.Create<MarkAanleverberichtAsRead>()));
    }
    ...
    public async Task Should_close_aanleveringbericht()
    {
        ...
        var command = Fixture.Build<MarkAanleverberichtAsRead>()
        ...
        Assert.AreEqual(true, dbEntity?.Gelezen);
    }
}